...
import { AltArrowRightBoldDuotone, CheckCircleBoldDuotone } from "solar-icon-set"
...
function DropdownMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <AltArrowRightBoldDuotone className="ml-auto" />
    </MenuPrimitive.SubmenuTrigger>
  )
}
